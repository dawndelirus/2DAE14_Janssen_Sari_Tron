...
{
public:
	GunComponent(std::shared_ptr<dae::GameObject> gameObject, std::shared_ptr<BulletPoolComponent> bulletPool
		, BulletComponent:: Type bulletType, int bounces, float fireCooldown, float bulletSpeed);
