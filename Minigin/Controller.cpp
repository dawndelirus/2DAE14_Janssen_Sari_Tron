...
bool Controller::IsPressed(ControllerButton button, int playerIndex) const
{
	return m_pImpl->IsPressed(button, playerIndex);
}

bool Controller::IsDownThisFrame(ControllerButton button, int playerIndex) const
{
	return m_pImpl->IsDownThisFrame(button, playerIndex);
}

bool Controller::IsReleasedThisFrame(ControllerButton button, int playerIndex) const
{
...
void Controller::AddInput(ControllerButton button, std::shared_ptr<Command> command, ButtonState state, int playerIndex)
{
	switch (state)
	{
...
//void dae::Controller::RemoveInput(int actionId)
//{
//	
//
//	//m_CommandsWhenDown
